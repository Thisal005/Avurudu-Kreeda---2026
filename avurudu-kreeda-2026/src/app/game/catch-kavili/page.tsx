...
export default function CatchKaviliPage() {
    ...
    <main className="min-h-screen bg-avurudu-bg flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-lg aspect-[9/18] md:aspect-[3/4] bg-avurudu-dark/10 rounded-3xl shadow-2xl relative z-10 overflow-hidden border-4 border-avurudu-yellow">
        ...
        {!gameOver ? (
          ...
          <div className="absolute inset-0 bg-avurudu-dark/95 flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-500">
